...
$senha = filter_input(INPUT_POST, 'senha', FILTER_SANITIZE_STRING); // Captura a senha
...
if ($validarLogin->rowCount() === 1) {
    ...
    if (password_verify($senha, $usuario['pass'])) {
        header('Location: index.php'); // Redireciona para a página segura
        exit();
    } else {
            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                <form method="post" action="login.php">
                    ...
                    <div class="text-center text-lg-start mt-4 pt-2">
                        ...
                        <p class="small fw-bold mt-2 mb-0">Don't have an account? <a href="#" class="link-danger">Register</a></p>
                    </div>
                </form>
            </div>
        </div>
...
<div class="d-flex flex-column flex-md-row text-center text-md-start justify-content-between py-4 px-4 px-xl-5 bg-primary">
    <div class="text-white mb-3 mb-md-6">
